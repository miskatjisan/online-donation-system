...
<div class="container-fluid px-1 py-5 mx-auto">
    ...
    @endif
            <div class="card">
                ...
                <form action="{{route('moneydonate.store')}}" method="POST" class="form-card">
                @csrf
                   ...
                   <input type="submit" class="btn btn-primary mt-3"  value="Donate Your Money"> 
